...
@mcp.tool()
def list_my_workgroup_entries(workgroup_uuid: str) -> str:
...
@mcp.tool()
def upload_file_to_my_workgroup(
    workgroup_uuid: str,
    filename: str,
...
@mcp.tool()
def add_member_to_my_workspace(
    workspace_uuid: str,
    email: str,
    role: str
) -> str:
...
@mcp.tool()
def remove_member_from_my_workspace(membership_uuid: str) -> str:
